...
- [Authentication Approaches](#authentication-approaches)
  - [Approach 1: Anonymous Read-Only Access](#approach-1-anonymous-read-only-access)
  ...
  - [Approach 5: Google OAuth for Contributions (SELECTED)](#approach-5-google-oauth-for-contributions-selected)
